...
# --------------------------------------------------------
_base_ = [
    '../_base_/models/upernet_r50.py', '../_base_/datasets/idd_aw.py',
...
model = dict(
    ...
    decode_head=dict(in_channels=[80, 160, 320, 640], num_classes=49,loss_decode=dict(type='HieraTripletLossCityscape',num_classes=26, loss_weight=1.0)),
